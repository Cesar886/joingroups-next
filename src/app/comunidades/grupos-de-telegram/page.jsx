  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.joingroups.lat/comunidades/grupos-de-telegram" />
      ...
      <div className={classes.pageBg}>
        <div className={classes.wrapper}>
          ...
          <div className={classes.hero}>
            ...
            <h1 className={classes.pageTitle}>Grupos de Telegram</h1>
          ...
          {currentGroups.length > 0 ? currentGroups.map((row, idx) => {
            ...
            return (
              <div
                ...
                onClick={() => router.push(`/comunidades/grupos-de-telegram/${slugify(mainCat)}/${slug}`)}
              >
          ...
          <div className={classes.footerCta}>
            ...
            <p className={classes.footerCtaText}>
              ...
              y conecta con una comunidad activa. También puedes aprender{' '}
              <Link href="/instrucciones-crear-grupo-telegram">cómo crear tu grupo de Telegram</Link>.
            </p>
